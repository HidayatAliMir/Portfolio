        ...
        <div className="ContactForm">
          ...
          <Container>
            <Row className="m-0 mt-5 mb-5">
              <Col lg={6} sm={12}>
                <img src={hidayat} alt="hidayat" className="ContactImage" />
                <div className="contactDetails">
                    Fill this form or directly contact me !!<br />
                  <a href="tel:8307747802">+91-605507133</a>
                  <br />
                  <a href="emailto:sngargrsd@gmail.com">meerhidayat563@gmail.com</a>
                </div>
              </Col>
              <Col lg={6} sm={12}>
                <div className="ques">
                ...
                <form onSubmit={e => this.submit(e)}>
                  ...
                  <InputGroup>
                    <InputGroupAddon addonType="prepend">
                      <InputGroupText>Message Subject</InputGroupText>
                    </InputGroupAddon>
                    <Input 
                    type="text" 
                    placeholder="Subject"
